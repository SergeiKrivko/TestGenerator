...
from src.main_tabs.code_tab.compiler_errors_window import CompilerErrorWindow
from src.main_tabs.tests.commands import CommandManager
from src.main_tabs.unit_testing.test_edit import UnitTestEdit, TestSuiteEdit
