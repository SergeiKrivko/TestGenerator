...
from PyQt6.QtWidgets import QWidget, QHBoxLayout, QVBoxLayout, QListWidget, QLabel, QComboBox, QPushButton, QProgressBar

from src.main_tabs.tests.gpt_generator import GPTTestGenerator
